                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="restaurant_website_link" id="restaurant_website_link" name="restaurant_website_link" placeholder="<?php echo get_phrase("enter_restaurant_website_link"); ?>" value="<?php echo sanitize($restaurant_data['website']); ?>" required>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                   <!-- <div class="form-group">
                                        ...
                                        <input type="number" step="0.01" id="delivery_charge" class="form-control" name="delivery_charge" placeholder="<?php echo sanitize(get_delivery_settings('delivery_charge')) . ' (' . get_phrase("default") . ') '; ?>" value="<?php echo sanitize($restaurant_data['delivery_charge']); ?>" min="0">
                                    </div> -->
                              ...
                              <div id="avg-time-selection" style="display: none">
                                ...
                                <div class="col-lg-6">
                                    <div class="alert alert-info lighten-info mt-4" role="alert">
                                        ...
                                        <p><?php echo get_phrase('you_can_overwrite_the_maximum_time_to_deliver'); ?>.</p>
                                    </div>
                                </div>
                            </div>
                        </form>
