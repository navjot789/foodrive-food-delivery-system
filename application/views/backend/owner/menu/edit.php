                        ...
                        <div class="row">
                            <div class="col-xl-6">
                                    ...
                                    <div class="form-group">
                                        <label for="name"><?php echo get_phrase("menu_name"); ?></label>
                                        <input type="text" readonly class="form-control border-0" id="name" name="name" placeholder="<?php echo "E.g : " . get_phrase("Chicken_Steak_Grilled_Burger"); ?>" value="<?php echo sanitize($menu_data['name']); ?>">
                                    </div>

                                    <div class="form-group">
                                        <label id="category_id"><?php echo get_phrase("menu_category"); ?></label>                                      
                                        <input type="text" readonly class="form-control border-0" id="category_id" name="category_id" placeholder="<?php echo "E.g : " . get_phrase("Chicken_Steak_Grilled_Burger"); ?>" value="<?php echo sanitize($categories[0]['name']); ?>">
                                    </div>
