                        ...
                        <div class="card">
                            ...
                            <div class="d-flex justify-content-center text-center">
                                ...
                                <div class="p-1 bd-highlight">
                                    <span class="<?php echo  ($earned['menu_earned'] > 0) ?'text-success' :'text-danger'; ?> display-3"> 
                                        <?php echo currency(sanitize(format(roundoff($earned['menu_earned'])))); ?>
                                    </span><br>  
                                    <span ><i class="fas fa-calendar"></i> Monthly Sale</span>
                                </div>
                            ...
                            <div class="d-flex justify-content-around  text-center">
                                ...
                                <div class="p-1 bd-highlight">
                                        <small class="<?php echo  ($earned['earned_total_tax'] > 0) ?'text-success' :'text-danger'; ?> lead"> 
                                            <?php echo currency(sanitize(format(roundoff($earned['earned_total_tax'])))); ?>
                                        </small><br>  
                                        <span ><i class="fas fa-calendar"></i> Total Tax</span>
                                </div>

                                <div class="p-1 bd-highlight">
                                        <small class="<?php echo  ($earned['earned_gst'] > 0) ?'text-success' :'text-danger'; ?> lead"> 
                                            <?php echo currency(sanitize(format(roundoff($earned['earned_gst'])))); ?>
                                        </small><br>  
                                        <span ><i class="fas fa-calendar"></i> G.S.T</span>
                                </div>

                                <div class="p-1 bd-highlight">
                                        <small class="<?php echo  ($earned['earned_pst'] > 0) ?'text-success' :'text-danger'; ?> lead"> 
                                            <?php echo currency(sanitize(format(roundoff($earned['earned_pst'])))); ?>
                                        </small><br>  
                                        <span ><i class="fas fa-calendar"></i> P.S.T</span>
                                </div>
