...
<script type="text/javascript">
  ...
  function calculateRestaurantRevenue(adminRevenue) {
    if (adminRevenue >= 0 && adminRevenue <= 100) {
      var total = 100;
      var restaurantRevenue = total - adminRevenue * 1;
      $('#restaurant_cut').val(restaurantRevenue);

      //owner-admin %, here owner will get always 100% and 15% as an exmaple above which admin get
      $('#foodrive_cut').text(adminRevenue);
    } else {
      $('#restaurant_cut').val(0);
    }
  }
</script>