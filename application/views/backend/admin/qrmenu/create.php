        ...
        <div class="row justify-content-center">
            <div class="col-lg-12">
                <div class="alert alert-info lighten-info alert-dismissible">
                    ...
                    <?php echo get_phrase('also_make_sure_that'); ?> <strong>GD2 PHP</strong> <?php echo get_phrase('extension_enabled'); ?>. <?php echo get_phrase('it_requires'); ?> <strong>GD2 PHP</strong> <?php echo get_phrase('extension_for_generating_an_image'); ?>.
                </div>
            </div>
            <div class="col-lg-6">
