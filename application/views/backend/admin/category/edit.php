                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            <input type="number" step="0.01" class="form-control" id="category-per" name="gst" placeholder="Enter Category GST %" value="<?php echo sanitize($category['tax']); ?>" >
                                ...
                                <div class="col-md-6"> 
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            <input type="number" step="0.01" class="form-control" id="category-per-pst" name="pst" placeholder="Enter Category PST %" value="<?php echo sanitize($category['pst']); ?>" >
                                            <div class="input-group-append">
                                                <span class="input-group-text"><i class="fas fa-percentage"></i></span>
                                            </div>
                                        </div>
