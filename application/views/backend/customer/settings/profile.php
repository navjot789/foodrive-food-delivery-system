                    ...
                    <div class="card-body">
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="address">
                                <form id="address" action="<?php echo site_url('settings/update'); ?>" method="post" >
                                    <input type="hidden" name="settings_type" id="settings_types" value="profile">
                                    <input type="hidden" name="updater" id="updaters" value="profile_address">
                                    <input type="hidden" name="uid" id="uid" value="<?php echo sanitize($user_info['id']); ?>">

                                <div class="form-group row">
                                    <label for="address_1" class="col-sm-2 col-form-label"><?php echo get_phrase('address'); ?><span class='text-danger'>*</span></label>
                                    <div class="col-sm-10">
                                        <textarea name="address_1" class="form-control" id="address_1" rows="2" placeholder="Enter your current location"><?php echo sanitize($user_info['address_1']); ?></textarea>
                                    </div>
                                </div>
                                <div class="form-group row hidden">
                                    <label for="latitude_1" class="col-sm-2 col-form-label"><?php echo get_phrase('latitude'); ?></label>
                                    <div class="col-sm-10">
                                        <input type="hidden" name="latitude_1" class="form-control" id="latitude_1" placeholder="<?php echo get_phrase('latitude_for_address_1'); ?>" value="<?php echo sanitize($user_info['coordinate_1']['latitude']); ?>" readonly>
                                ...
                                <div class="form-group row hidden">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="hidden" class="form-control" id="longitude_1" name="longitude_1" placeholder="<?php echo get_phrase("longitude_for_address_1"); ?>" value="<?php echo sanitize($user_info['coordinate_1']['longitude']); ?>" readonly>
                                        <small class="float-right"><a href="https://youtu.be/CgFiSJ11Uk8" target="_blank"><?php echo get_phrase("how_to_get_it"); ?>?</a></small>
                                    </div>
                                </div>
